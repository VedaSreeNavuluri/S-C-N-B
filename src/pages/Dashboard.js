...
import { /* useNavigate removed (not used) */ } from 'react-router-dom';
import NoticeCard from '../components/notices/NoticeCard';
// LoadingSpinner removed (not used) to avoid unused import lint warnings
...
const Dashboard = () => {
  ...
  // Navigation handlers can be added later when needed

...
const Login = () => {
  ...
  const demoAccounts = [
    ...
    { email: 'prof.sharma@college.edu', password: 'faculty123', role: 'Faculty' },
    { email: 'alice.cse@college.edu', password: 'student123', role: 'Student' },
    { email: 'john.mech@college.edu', password: 'student123', role: 'Student' }
  ];
